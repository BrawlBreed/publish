...
const { getAllProducts, createProduct, updateProduct, deleteProduct, getProductDetails, getProductReviews, deleteReview, createProductReview, getAllProductsAdmin, updateProductStock} = require("../controller/productController");
...
router.route("/admin/productStock/:id").put(updateProductStock);
